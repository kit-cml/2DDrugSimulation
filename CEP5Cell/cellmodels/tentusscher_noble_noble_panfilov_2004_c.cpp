...
#include "tentusscher_noble_noble_panfilov_2004_c.hpp"
#include <cmath>
...
tentusscher_noble_noble_panfilov_2004_c::tentusscher_noble_noble_panfilov_2004_c()
{
algebraic_size = 67;
constants_size = 46;
states_size = 17;
...
void tentusscher_noble_noble_panfilov_2004_c::initConsts()
{
STATES[0] = -86.2;
...
void tentusscher_noble_noble_panfilov_2004_c::computeRates( double TIME, double *CONSTANTS, double *RATES, double *STATES, double *ALGEBRAIC )
{
...
ALGEBRAIC[18] = (STATES[0]<- 40.0000 ?  0.0570000*exp(- (STATES[0]+80.0000)/6.80000) : 0.000000);
...
ALGEBRAIC[19] = (STATES[0]<- 40.0000 ? (( ( - 25428.0*exp( 0.244400*STATES[0]) -  6.94800e-06*exp( - 0.0439100*STATES[0]))*(STATES[0]+37.7800))/1.00000)/(1.00000+exp( 0.311000*(STATES[0]+79.2300))) : 0.000000);
...
ALGEBRAIC[0] = (TIME -  floor(TIME/CONSTANTS[6])*CONSTANTS[6]>=CONSTANTS[5]&&TIME -  floor(TIME/CONSTANTS[6])*CONSTANTS[6]<=CONSTANTS[5]+CONSTANTS[7] ? - CONSTANTS[8] : 0.000000);
#else
...
RATES[16] = (ALGEBRAIC[12]>STATES[16]&&STATES[0]>- 60.0000 ? 0.000000 : ALGEBRAIC[25]);
...
RATES[12] = (ALGEBRAIC[43]>STATES[12]&&STATES[0]>- 60.0000 ? 0.000000 : ALGEBRAIC[46]);
...
void tentusscher_noble_noble_panfilov_2004_c::solveAnalytical(double dt)
{
