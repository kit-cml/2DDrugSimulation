 ...
 * STATES[41] is qnet in component unknown (dimensionless).
 * STATES[42] is INaL_AUC in component unknown (dimensionless).
 * STATES[43] is ICaL_AUC in component unknown (dimensionless).
 * RATES[0] is d/dt v in component membrane (millivolt).
 * RATES[1] is d/dt CaMCONSTANTS[189] in component CaMK (millimolar).
 ...
 * RATES[41] is d/dt qnet in component unknown (dimensionless).
 * RATES[42] is d/dt INaL_AUC in component unknown (dimensionless).
 * RATES[43] is d/dt ICaL_AUC in component unknown (dimensionless).
 */
...
CONSTANTS[139] = 10.0;
CONSTANTS[140] = 1000.0;
STATES[41] = 0.;
STATES[42] = 0.;
STATES[43] = 0.;
}

void Ohara_Rudy_2011::___initStates_bepridil()
{
STATES[0] = -88.047726;
STATES[1] = 0.008678;
STATES[2] = 0.000073;
...
void Ohara_Rudy_2011::initConsts(double type, double D, double *hill, bool is_dutta, const char *drug_name)
{

initConsts(type);

#ifndef SINGLE_CELL
if(strcasecmp(drug_name, "bepridil") == 0) ___initStates_bepridil();
#endif
...
CONSTANTS[99]  *= (hill[0] > 10E-14 && hill[1] > 10E-14) ? 
                  pow(1.+pow(D/hill[0], hill[1]), -1) : 1.;
CONSTANTS[103] *= (hill[2] > 10E-14 && hill[3] > 10E-14) ? 
                  pow(1.+pow(D/hill[2], hill[3]), -1) : 1.;
CONSTANTS[102] *= (hill[4] > 10E-14 && hill[5] > 10E-14) ? 
                  pow(1.+pow(D/hill[4], hill[5]), -1) : 1.;
CONSTANTS[42]  *= (hill[6] > 10E-14 && hill[7] > 10E-14) ? 
                  pow(1.+pow(D/hill[6], hill[7]), -1) : 1.;
CONSTANTS[96]  *= (hill[8] > 10E-14 && hill[9] > 10E-14) ? 
                  pow(1.+pow(D/hill[8], hill[9]), -1) : 1.;
CONSTANTS[97]  *= (hill[10] > 10E-14 && hill[11] > 10E-14) ? 
                  pow(1.+pow(D/hill[10], hill[11]), -1) : 1.;
CONSTANTS[101] *= (hill[12] > 10E-14 && hill[13] > 10E-14) ? 
...
ALGEBRAIC[12] = (TIME>=CONSTANTS[139] && (TIME - CONSTANTS[139]) - floor((TIME - CONSTANTS[139])/CONSTANTS[140])*CONSTANTS[140]<=CONSTANTS[13] ? CONSTANTS[12] : 0.000000);
#elif
if(isS1) ALGEBRAIC[12] = CONSTANTS[12];
else ALGEBRAIC[12] = 0.0;
#endif
...
RATES[41] = (ALGEBRAIC[64]+ALGEBRAIC[81]+ALGEBRAIC[70]+ALGEBRAIC[96]+ALGEBRAIC[98]+ALGEBRAIC[100]);
RATES[42] = ALGEBRAIC[64];
RATES[43] = ALGEBRAIC[81];
}
