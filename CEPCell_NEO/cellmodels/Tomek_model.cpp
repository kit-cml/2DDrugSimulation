...
CONSTANTS[tauCa] = 0.2;
CONSTANTS[bt] = 4.75;
STATES[Jrel_np] = 1.6129e-22;
STATES[Jrel_p] = 1.2475e-20;
...
void Tomek_model::___initEpi()
{
CONSTANTS[celltype] = 1;
CONSTANTS[nao] = 140.0;
CONSTANTS[cao] = 1.8;
CONSTANTS[ko] = 5.0;
CONSTANTS[clo] = 150.0;
...
STATES[ffp] = 1.0;
STATES[fcafp] = 1.0;
STATES[nca_ss] = 0.00030853;
STATES[nca_i] = 0.00053006;
CONSTANTS[tjca] = 75;
CONSTANTS[vShift] = 0;
CONSTANTS[offset] = 0;
CONSTANTS[dielConstant] = 74;
CONSTANTS[ICaL_fractionSS] = 0.8;
CONSTANTS[GKr_b] = 0.0321;
STATES[C1] = 0.00067941;
STATES[C2] = 0.00082869;
STATES[C3] = 0.9982;
STATES[I] = 9.5416e-06;
STATES[O] = 0.00027561;
CONSTANTS[alpha_1] = 0.154375;
...
void Tomek_model::___initMid()
{
CONSTANTS[celltype] = 2;
CONSTANTS[nao] = 140.0;
CONSTANTS[cao] = 1.8;
CONSTANTS[ko] = 5.0;
CONSTANTS[clo] = 150.0;
...
CONSTANTS[ICaL_fractionSS] = 0.8;
CONSTANTS[GKr_b] = 0.0321;
STATES[C1] = 0.00069560;
STATES[C2] = 0.00082672;
STATES[C3] = 0.9979;
STATES[I] = 1.8784e-05;
STATES[O] = 0.00054206;
CONSTANTS[alpha_1] = 0.154375;
...
void Tomek_model::initConsts(double celltype)
{
if(celltype == 0.) ___initEndo();
else if(celltype == 1.) ___initEpi();
else if(celltype == 2.) ___initMid();
}

void Tomek_model::initConsts(double celltype, double D, double *hill)
{
initConsts(celltype);
