...
ten_tusscher_model_2006_IK1Ko_epi_units::ten_tusscher_model_2006_IK1Ko_epi_units()
{
algebraic_size = 70;
constants_size = 53;
states_size = 19;
...
void ten_tusscher_model_2006_IK1Ko_epi_units::initConsts( )
{
STATES[0] = -85.23;
...
void ten_tusscher_model_2006_IK1Ko_epi_units::computeRates( double TIME, double *CONSTANTS, double *RATES, double *STATES, double *ALGEBRAIC )
{
...
void ten_tusscher_model_2006_IK1Ko_epi_units::solveAnalytical(double dt)
{
// Exact solution
